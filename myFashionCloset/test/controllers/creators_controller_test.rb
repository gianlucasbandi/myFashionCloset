...
class CreatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create creator" do
    assert_difference("Creator.count") do
      post creators_url, params: { creator: { approved: @creator.approved, birthday: @creator.birthday, firstName: @creator.firstName, gender: @creator.gender, lastName: @creator.lastName, styleDesc: @creator.styleDesc } }
    end
  ...
  test "should update creator" do
    patch creator_url(@creator), params: { creator: { approved: @creator.approved, birthday: @creator.birthday, firstName: @creator.firstName, gender: @creator.gender, lastName: @creator.lastName, styleDesc: @creator.styleDesc } }
